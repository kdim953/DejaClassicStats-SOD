...
local L = namespace.L 				--localization
	...
	--About DCS Frame --
	--------------------
	local DCSAboutDCSFrame = CreateFrame("Button", "DCSAboutDCSFrame", SettingsPanel) -- Parent is InterfaceOptionsFrame so that it can show over check boxes as checkboxes text is the highest level "TOOLTIP" and cannot be hidden or overlayed.
	...
	local DCSAboutDCS_FS = DCSAboutDCSFrame:CreateFontString("DCSAboutDCS_FS", "OVERLAY", "GameFontNormal")
		DCSAboutDCS_FS:SetText(
			...
			"|cff0094c4    German:|r COl3RA79, barneyandroid, Scap04, pas06, flow0284, Markurion, Branduril, NekoNyaaaa" .. "|n" .. 						--(German)
